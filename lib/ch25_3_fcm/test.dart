...
Future<void> showNotification({
  ...
  notiPlugin.show(
    ...
    NotificationDetails(
      ...
      iOS: const DarwinNotificationDetails(   // IOSNotificationDetails 대신 DarwinNotificationDetails 사용
        badgeNumber: 1,
...
class MyHomePage extends StatefulWidget {
  const MyHomePage({Key? key, required this.title}) : super(key: key);    // 생성자
